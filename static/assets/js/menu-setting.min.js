...
$(document).ready(function () {
    ...
    $(".layout-type > a").on("click", function () {
        ...
        if (a == "dark") {
            ...
            $(".layout-css").attr("href", "backend/css/layout-dark.css");
        } else {
    ...
    $("#theme-rtl").change(function () {
        ...
        if ($(this).is(":checked")) {
            $(".rtl-css").attr("href", "backend/css/layout-rtl.css");
        } else {
            $(".rtl-css").attr("href", "");
        }
    });
